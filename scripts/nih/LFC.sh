...
deepspeed --master_port 29500 --include localhost:0 ${BASE_DIR}/train/finetune.py \
    ...
    --train_files ${DATA_DIR}/dataset/dk/10p_sft/training_10%.jsonl \
    --validation_files ${DATA_DIR}/dataset/dk/10p_sft/validation_10%.jsonl \
    --test_files ${DATA_DIR}/dataset/dk/10p_sft/testing_10%.jsonl \
